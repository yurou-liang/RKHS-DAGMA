...
import math
"""
m1 = input dim of layer, at first layer m1 := dims[0] = d = number of covariates?
m2 = output dim of layer
"""

class LocallyConnected(nn.Module):
    """one Local linear layer, i.e. Conv1dLocal() with filter size 1.
    ...
    def forward(self, input: torch.Tensor):
        ...
        #  if you have a tensor A of shape (a, b, c, d) and another tensor B of shape (a, b, d, e), the result will be a tensor of shape (a, b, c, e) where each (c, d) sub-matrix of A is multiplied with its corresponding (d, e) sub-matrix in B.
